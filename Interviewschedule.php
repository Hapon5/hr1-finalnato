...
<html lang="en">
  <head>
    ...
    <style>
        ...
        .sidebar { width: 260px; background-color: black; color: white; padding: 20px; display: flex; flex-direction: column; transition: all 0.3s ease; position: fixed; left: 0; top: 0; bottom: 0; z-index: 100; }
        ...
        .sidebar-nav a { display: flex; align-items: center; padding: 12px 15px; border-radius: 8px; text-decoration: none; color: var(--text-light); background-color: transparent; transition: background-color 0.3s ease; white-space: nowrap; }
        .sidebar-nav a:hover { background-color: rgba(0, 0, 0, 0.2); }
        .sidebar-nav a.active { background-color: rgba(0, 0, 0, 0.15); font-weight: 500; }
        .sidebar-nav a i { font-size: 20px; margin-right: 15px; min-width: 20px; text-align: center; }
...
<body class="bg-gray-50 font-sans">
    ...
    <nav class="sidebar text-white" style="background-color: #000;">
        ...
        <ul class="sidebar-nav text-white">
            <li class="text-white"><a href="admin.php" class="text-white"><i class="fas fa-tachometer-alt text-white"></i><span class="text-white">Dashboard</span></a></li>
            <li class="logout-item text-white"><a href="logout.php class="text-white"><i class="fas fa-sign-out-alt text-white"></i><span class="text-white">Logout</span></a></li>
        </ul>
    </nav>
    ...
    <div id="interviewModal" class="fixed inset-0 bg-black/50 hidden z-50 flex items-center justify-center p-4 ">
        <div class=" rounded-lg shadow-xl max-w-2xl w-full max-h-screen overflow-y-auto" style="background-color: #000;">
            ...
            <form id="interviewForm" method="POST" class="p-6" ">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-white text-sm font-medium text-white-700  mb-1">Position*</label>
                        <input type="text" name="position" required class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                    </div>
                    <div>
                        <label class="block text-white  text-sm font-medium text-white-700  mb-1">Interviewer*</label>
                        <input type="text" name="interviewer" required class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block  text-sm font-medium text-white-700 mb-1">Start Time*</label>
                        <input type="datetime-local" name="start_time" required class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                    </div>
                    <div>
                        <label class="block text-white text-sm font-medium text-white-700 mb-1">End Time*</label>
                        <input type="datetime-local" name="end_time" required class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                    </div>
                </div>
                 <div class="mb-4">
                    <label class="block text-white text-sm font-medium text-white-700 mb-1">Location*</label>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-4 py-2 bg-brand-500 text-white-700 rounded-lg hover:bg-brand-600" style="background-color: green;" >Save Schedule</button>
                </div>
            </form>
        </div>
    </div>
