...
<body class="font-sans text-gray-800 antialiased">
    <header class="fixed inset-x-0 top-0 z-50 bg-hero-gradient shadow">
        <nav class="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
            ...
            <a href="/login.php" class="ml-6 hidden rounded-full bg-white px-5 py-2 font-semibold text-brand-500 shadow hover:bg-gray-100 md:inline-block">Login</a>
        </nav>
        <div id="mobileMenu" class="hidden md:hidden">
            <div class="mx-auto max-w-7xl px-6 pb-4">
                <ul class="space-y-2">
                    ...
                    <li><a href="/login.php" class="mt-2 inline-block rounded-full bg-white px-5 py-2 font-semibold text-brand-500 shadow hover:bg-gray-100">Login</a></li>
                </ul>
            </div>
        </div>
    </header>
    ...
    <section class="relative overflow-hidden bg-hero-gradient pt-28 pb-16 text-white">
        ...
        <div class="relative z-10 mx-auto max-w-4xl px-6 text-center">
            ...
            <div class="mt-8 flex flex-wrap items-center justify-center gap-3">
                <a href="/login.php" class="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-lg font-semibold text-brand-500 shadow transition hover:-translate-y-0.5 hover:bg-gray-100">
            ...
            <div class="grid grid-cols-1 gap-8 pb-8 md:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="mt-3 space-y-2">
                        <li><a class="hover:text-brand-500 transition" href="/login.php">Login</a></li>
