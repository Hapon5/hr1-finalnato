        ...
        <section class="relative overflow-hidden bg-hero-gradient pt-28 pb-16 text-white">
            ...
            <div class="relative z-10 mx-auto max-w-4xl px-6 text-center">
                ...
                <div class="mt-8 flex flex-wrap items-center justify-center gap-3">
                    <a href="/" class="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-lg font-semibold text-brand-500 shadow transition hover:-translate-y-0.5 hover:bg-gray-100">
