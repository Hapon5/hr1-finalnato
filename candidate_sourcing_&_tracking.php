...
<body class="bg-gray-50 font-sans">
    ...
    <div class="lg:ml-64">
        ...
        <div class="p-6">
            ...
            <div class="bg-dark rounded-lg shadow-sm p-6 mb-6" style="background-color: #0000;">
                <div class=" bg-dark flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4" style="background-color: #0000;">
