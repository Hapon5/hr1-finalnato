...
<html lang="en">
          ...
          <div class="menu-title">
            ...
            <ul class="menu-items submenu">
              ...
              <li class="item1">
                <a>RECRUITMENT</a>
                <div class="dropdown-content">
                <a href="../modules/job_posting.php"><small>JOB POSTING</small></a>
  ...
  <h1 class="page-title">Job Posting</h1>

  <div class="container">
  <div class="top-bar">
      <button id="openModalBtn" class="btn">Add Job Posting</button>
...
function openModal(edit = false) {
    ...
    if (!edit) {
        document.getElementById("modalTitle").innerText = "Add New Job Posting";
