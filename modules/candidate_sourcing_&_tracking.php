...
button[type="submit"]:hover {
  ...
  <body>
    <nav class="sidebar">
      ...
      <div class="menu-content">
        <ul class="menu-items">
            <div class="menu-title"><small></small></div>
              <li class="item">
          ...
          <span class="icon"><i class='bx bx-group'></i></span>
            ...
            <li class="item">
              <span class="icon"><i class="fa-solid fa-gear"></i></span>
                <a href="aboutus.html" class="nav_link"></a>
            </li>
   ...
   <h2 style="text-align: center;">Candidate Form</h2>
  <div class="form-row">
  ...
  <div class="form-row">
    ...
    <div class="form-group">
      <label for="experience">Experience (months/years):</label>
